    ...
    <header className={styles.Header}>
      <div className="container">
        ...
        <ul>
          ...
          <li>{!user ? <NavLink to="/Connexion" className={({ isActive }) => (isActive ? styles.activeLink : undefined)}>Se connecter</NavLink> : <span tabIndex={0} role="button" onKeyUp={disconnect} onClick={disconnect} className={styles.logout}>Se déconnecter</span> }</li>
        </ul>
      </div>
    </header>
  );
